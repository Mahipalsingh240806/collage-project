...
function normalizeMedicalText(text) {
  ...
  const replacements = [
    ...
    ["sugar", "diabetes"],
    ["bp", "blood pressure"],
    ["dengu" , "Dengue / Malaria"],
    ["maleriya" , "Dengue / Malaria"],
    ["heart attack" , " Heart Problem"],
    ["chest problem" , " Heart Problem"],
    ["heart" , " Heart Problem"],
    ["lakava" , "Stroke"],
    ["strock" , "Stroke"],
    ["paralysis" , "Stroke"],
    ["asthma" , "Asthma"],
    ["breathing" , "Asthma"],
    ["snas me problem" , "Asthma"],
    ["lungs problem" , "Asthma"],
    ["stress" , " Stress / Anxiety"],
    ["anxiety" , " Stress / Anxiety"],
    ["metal health problem" , " Stress / Anxiety"],
    ["tooth pain" , "Tooth Pain"],
    ["daat dard" , "Tooth Pain"],
    ["cavity" , "Tooth Pain"],
    ["Eye Problem" , "Eye Problem"],
    ["eye pain" , "Eye Problem"],
    ["aakh me dard" , "Eye Problem"],
    ["red eye" , "Eye Problem"],
    ["eye infection" , "Eye Problem"],
    ["kaan me dard" , "Ear Problem"],
    ["ear pain" , "Ear Problem"],
    ["Skin Problem" , "Skin Problem"],
    ["itiching" , "Skin Problem"],
    ["fungle" , "Skin Problem"],
    ["Diabetes" , "Diabetes"],
    ["diabetes" , "Diabetes"],
    ["sugar" , "Diabetes"],
